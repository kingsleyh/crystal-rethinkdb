...
describe RethinkDB do
  ...
  {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/edge.yaml") }}
  
  # {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/geo.rb.yaml") }}
  # {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/idxcopy.yaml") }}
  # {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/include_states.yaml") }}
  # {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/point.yaml") }}
  # {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/sindex.yaml") }}
  # {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/squash.yaml") }}
  # {{ run("./reql_spec_generator", "spec/rql_test/src/changefeeds/table.yaml") }}
  ...
  # {{ run("./reql_spec_generator", "spec/rql_test/src/selection.yaml") }}
  {{ run("./reql_spec_generator", "spec/rql_test/src/times/api.yaml") }}
end
